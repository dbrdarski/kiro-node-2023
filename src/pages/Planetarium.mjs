    ...
    <section class="content-area">
      <div class="col-content content col-wide">
        ...
        <p style="font-size: 23px; line-height: 1.7em; opacity: .74; margin: 0;">
          Planetarium is the first painting to be worked all over the world. Among the locations were historical sites like
          the Tomb of Jesus Christ and the Wailing Wall in Jerusalem, New York, the Berlin Wall, Nerezi, Ohrid, Brussels,
          Knokke-le-Zoute, Bruges, Paris, Rome, Pompeii, Pisa, the Suez Canal, London, Stonehenge, Athens, Cape Soúnion,
          the Nile, the Great Pyramids in Giza, Kenya (Masai Mara), Machu Picchu, Cuzco, Bangkok, Peking (the Forbidden City)
          and the Great Wall of China, Tokyo, Kamakura, Mont Saint-Michel, Nuenenn and Eindhoven.
        </p>
      </div>
    </section>
    <section class="content-area">
      <aside class="col-aside">
        ...
        <div class="info-card-link" style="padding: 20px 0; font-size: 23px; width: 100%;">
          <a href="/photo-gallery/planetarium"
