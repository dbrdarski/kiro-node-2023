export default ({ props: { color, ...props } }) => (
  <svg
    style={`height: 20px; fill: ${ color ?? "#FF5B19" };`}
    {...props}
    version="1.0" id="katman_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
