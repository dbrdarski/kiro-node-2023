<?php /* Template Name: Planetarium Page Template */ ?>

<?php get_header(); ?>
		
		<div id="superhead" class="x4" style="margin-bottom:0">				
		<?php //query_posts( $query_string . '&cat=3' ) ?>		
		<?php if (have_posts()) : ?>
		<?php $main_query = clone $wp_query; ?>		
		<?php global $post;
		$tmp_post = $post;
		//$args = array( 'post_parent' => $post->ID, 'post_type' => 'page',  'order' => 'ASC', 'orderby' => 'menu_order ID' );
		...
		<img src="<?php bloginfo('template_url');?>/images/planetarism.png" alt="" >
		</div>
